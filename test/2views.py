...
renderView2.ViewSize = [832, 150]
renderView2.AxesGrid = 'GridAxes3DActor'
renderView2.CenterOfRotation = [200.0, 1000.0, 0.0]
renderView2.StereoType = 0
renderView2.CameraPosition = [200.0, 1000.0, 3940.2197095449555]
renderView2.CameraFocalPoint = [200.0, 1000.0, 0.0]
...
data0Display_1.ColorArrayName = ['CELLS', 'T']
data0Display_1.LookupTable = tLUT
...
# get color legend/bar for tLUT in view renderView2
tLUTColorBar = GetScalarBar(tLUT, renderView2)
