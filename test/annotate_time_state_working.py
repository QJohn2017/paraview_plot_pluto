...
renderView1.ViewSize = [570, 330]
renderView1.AxesGrid = 'GridAxes3DActor'
renderView1.CenterOfRotation = [200.0, 1000.0, 0.0]
renderView1.StereoType = 0
renderView1.CameraPosition = [325.36056919074946, 139.99205045388715, -2547.028212213549]
renderView1.CameraFocalPoint = [199.99999999999997, 999.9999999999998, -3.1741411682143124e-14]
renderView1.CameraViewUp = [0.9980742262287294, -0.023964023442757262, 0.05721507247533889]
...
rhoLUT.RGBPoints = [4.357020577661075e-10, 0.231373, 0.298039, 0.752941, 7.26731256908697e-07, 0.865003, 0.865003, 0.865003, 1.4530268117596279e-06, 0.705882, 0.0156863, 0.14902]
...
# show data from pythonAnnotation2
pythonAnnotation2Display = Show(pythonAnnotation2, renderView1)

# trace defaults for the display properties.
pythonAnnotation2Display.FontFile = ''
...
rhoPWF.Points = [4.357020577661075e-10, 0.0, 0.5, 0.0, 1.4530268117596279e-06, 1.0, 0.5, 0.0]
