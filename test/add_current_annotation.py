...
calculator1Display.OSPRayScaleArray = 'current'
...
calculator1Display.SetScaleArray = ['POINTS', 'current']
calculator1Display.ScaleTransferFunction = 'PiecewiseFunction'
calculator1Display.OpacityArray = ['POINTS', 'current']
